...
> esta é uma tradução de  https://processing.org/tutorials/anatomy/ mantendo a licença [Creative Commons BY-NC-SA 4.0](http://creativecommons.org/licenses/by-nc-sa/4.0/).    
...
Remember that what you are seeing here is my particular thought process and programming style. There are many different approaches and styles. As you continue programming, you will find your own. You can also see other people’s programming stye (though not their thought process!) by looking at the source code for the programs at [openProcessing.org](http://openprocessing.org/).    
